<h1 class="mb-5">Mon profil sportif</h1>
<!-- Profil utilisateur -->
        ...
        <div class="card-body position-relative ">
          ...
          <div id="modifMail" class="d-none">
            <form method="POST" action="<?= URL; ?>compte/validation_modifMail">
              <div class="row">
                <div class="col-8">
                  <input type="email" class="form-control mb-3" name="mail" placeholder="Entrez votre nouvel email" />
                </div>
                <div class="col-2">
          ...
          <!-- Password -->
          <div>
            <a href="<?= URL ?>compte/modifPassword" class="btn btn-inverse">Modifier mon mot de passe</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <table class="table table-hover">
        ...
        <tbody>
          <tr>
            ...
            <td> <button class="btn btn-light btn-sm" id="btnModifZone"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
                  <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z" />
                </svg> </button> </td>
          </tr>
          <td colspan="3">
            <div id="modifZone" class="d-none">
          ...
          <tr>
            ...
            <td> <button class="btn btn-light btn-sm" id="btnModifObjectif"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
                  <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z" />
                </svg> </button> </td>
          </tr>
          <td colspan="3">
            <div id="modifObjectif" class="d-none">
              <form method="POST" action="<?= URL; ?>compte/validation_modifObjectif">
                <div class="row p-2">
                  <div class="col-8"> <select name="objectif" class="form-control">
                      <option value="cardio">Santé cardiovasculaire,endurance, perte du poids</option>
                      <option value="cycle"> Gestion stress, émotions, douleurs menstruels </option>
                      <option value="tonus">Tonification et renforcement de la masse musculaire</option>
                      <option value="equilibre">Equilibre et coordination des mouvements</option>
                    </select> </div>
                  <div class="col-2"> <button class="btn btn-success" type="submit"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check" viewBox="0 0 16 16">
                        <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z" />
                      </svg> </button> </div>
          ...
          <tr>
            ...
            <td> <button class="btn btn-light btn-sm" id="btnModifNiveau"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
                  <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z" />
                </svg> </button> </td>
          </tr>
          <td colspan="3">
            <div id="modifNiveau" class="d-none">
              <form method="POST" action="<?= URL; ?>compte/validation_modifNiveau">
                <div class="row p-2">
                  <div class="col-8"> <select name="niveau" class="form-control">
          ...
          <tr>
            ...
            <td> <button class="btn btn-light btn-sm" id="btnModifRituel"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
                  <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z" />
                </svg> </button> </td>
          </tr>
          <td colspan="3">
            <div id="modifRituel" class="d-none">
              <form method="POST" action="<?= URL; ?>compte/validation_modifRituel">
                <div class="row p-2">
                  <div class="col-8"> <select name="rituel" class="form-control">
                      <option value="douche">Avant la douche</option>
                      <option value="reveil">Des le reveil</option>
                      <option value="petit-dej">Avant/Après le petit dejeuner</option>
                      <option value="pause-dej">Pendant la pause dejeuner</option>
                      <option value="afterwork">Après le travail</option>
                      <option value="sommeil-enfants">Pendant le sommeil des enfants</option>
                      <option value="diner">Avant/Après le petit diner</option>
                    </select> </div>
                  <div class="col-2"> <button class="btn btn-success" type="submit"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check" viewBox="0 0 16 16">
                        <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z" />
                      </svg> </button> </div>
      ...
      <form method="POST" action="<?= URL; ?>compte/validation_modifJours">
        <div class="row p-2">
          ...
          <tr>
            ...
            <td> <button class="btn btn-light btn-sm" id="btnModifDuree"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
                  <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z" />
                </svg> </button> </td>
          </tr>
          <td colspan="3">
            <div id="modifDuree" class="d-none">
              <form method="POST" action="<?= URL; ?>compte/validation_modifDuree">
                <div class="row p-2">
                  <div class="col-8"> <select name="duree_max" class="form-control">
