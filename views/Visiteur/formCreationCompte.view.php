<h1>Création de compte et personnalisation ... <br> je renseigne mon profil sportif </h1>
<form method="POST" action ="validation_creationCompte">
  <fieldset>
...
<fieldset>
  ...
  <input type="mail" class="form-control mb-3" id="mail" name="mail">

  <button class="btn-p" type="submit">Créer et personnaliser</button>
</form>