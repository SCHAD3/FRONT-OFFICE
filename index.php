...
try {
    ...
    switch ($page) {
        ...
        case "validation_login":
            ...
            break;
        case "creationCompte":
            $visiteurController->formCreationCompte();
            break;
        ...
        case "compte":
            if (!Securite::isConnect()) {
                ...
                switch ($url[1]) {
                    ...
                    case "deconnexion":
                        ...
                        break;
                    case "validation_modifMail":
                        $utilisateurController->validation_modifMail(Securite::secureHTML($_POST['mail']));
                        break;
                    case "modifPassword":
                    ...
                    case "validation_modifImage":
                        ...
                        break;
                    case "validation_modifZone":
                        $utilisateurController->validation_modifZone(Securite::secureHTML($_POST['zone']));
                        break;
                    case "validation_modifDuree":
                        $utilisateurController->validation_modifDuree(Securite::secureHTML($_POST['duree_max']));
                        break;
                    case "validation_modifJours": 
                            $utilisateurController->validation_modifJours($jours);
                        break;
                    case "validation_modifNiveau": 
                                $utilisateurController->validation_modifNiveau(Securite::secureHTML($_POST['niveau']));;
                        break;
                    case "validation_modifObjectif": 
                                    $utilisateurController->validation_modifObjectif(Securite::secureHTML($_POST['objectif']));;
                        break;
                    case "validation_modifRituel": 
                    $utilisateurController->validation_modifRituel(Securite::secureHTML($_POST['rituel']));;
                    break;
            ...
            break;
        case "formProgrammeP":
            $visiteurController->formProgrammeP();
            break;
        case "pageConseil":
            $visiteurController->pageConseil();
            break;
        case "formContact":
            $visiteurController->formContact();
            break;
        default:
